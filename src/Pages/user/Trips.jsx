...
const Trips = ({ Toggle }) => {
  ...
  const fetchData = async (id) => {
    try {
      const response = await fetch(
        `http://localhost:8080/api/trips/tripsByUserID/${id}`,
        {
          method: "GET",
          headers: {
  ...
  const deleteBook = async (id) => {
    ...
    if (conf) {
      const response = await fetch(
        "http://localhost:8080/api/trips/deletetrips/" + id,
        {
          method: "delete",
          headers: {
            "Content-Type": "application/json",
  ...
  const getBookDataByID = async (id) => {
    ...
    // console.log(mainId);
    const response = await fetch(
      "http://localhost:8080/api/trips/tripsByID/" + id,
      {
        method: "get",
        headers: {
          "Content-Type": "application/json",
  ...
  const handleAdd = async (e) => {
    ...
    if (places.current.value === "") {
      ...
      const response = await fetch("http://localhost:8080/api/trips/addtrips", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleUpdate = async (e) => {
    ...
    if (places.current.value === "") {
      ...
      const response = await fetch(
        "http://localhost:8080/api/trips/updatetrips/" + bookId,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
