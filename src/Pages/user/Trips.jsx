...
const Trips = ({ Toggle }) => {
  ...
  const deleteBook = async (id) => {
    ...
    if (conf) {
      const response = await fetch(BASE_URL + "trips/deletetrips/" + id, {
        method: "delete",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      if (response.status === 200) {
        Swal.fire({
          icon: "success",
          title: "Trips Deleted successfully!",
        });
  ...
  const downloadReport = async () => {
    try {
      const response = await fetch(
        BASE_URL + "trips/getReportData/" + userId.id,
        {
          method: "GET",
          headers: {
            authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const getBookDataByID = async (id) => {
    ...
    // console.log(mainId);
    const response = await fetch(BASE_URL + "trips/tripsByID/" + id, {
      method: "get",
      headers: {
        "Content-Type": "application/json",
        authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleAdd = async (e) => {
    ...
    if (places.current.value === "") {
      Swal.fire({
        icon: "warning",
        title: "Please enter Places Visited!",
      });
      ...
      const response = await fetch(BASE_URL + "trips/addtrips", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      if (response.status === 201) {
        ...
        Swal.fire({
          icon: "success",
          title: "New Trips Added successfully!",
        });
      }
    }
  };
  ...
  const handleUpdate = async (e) => {
    ...
    if (places.current.value === "") {
      ...
      const response = await fetch(BASE_URL + "trips/updatetrips/" + bookId, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      if (response.status === 200) {
        ...
        Swal.fire({
          icon: "success",
          title: "Trips Updated successfully!",
        });
      }
    }
  };
          ...
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title fs-5" id="exampleModalLabel">
                Add New / Update Trips & Tours Details
              </h1>
              <button
                type="button"
                className="btn-close"
                  ...
                  <div className="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                    <div className="form-floating w-100">
                      ...
                      <input
                        ...
                        id="numbook"
                        defaultValue={bookObj.places}
                        placeholder="Name"
                        ref={places}
                        // onChange={(e) => setIsName(e.target.value)}
                      />
                      <label htmlFor="floatingInput">
                        Enter Places Visited
                      </label>
                    </div>
                  </div>
                </div>
