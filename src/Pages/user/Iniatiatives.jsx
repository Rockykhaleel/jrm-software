...
const Iniatiatives = ({ Toggle }) => {
  ...
  const fetchData = async (id) => {
    try {
      const response = await fetch(
        `http://localhost:8080/api/other/otherByUserID/${id}`,
        {
          method: "GET",
          headers: {
  ...
  const deleteBook = async (id) => {
    ...
    if (conf) {
      const response = await fetch(
        "http://localhost:8080/api/other/deleteother/" + id,
        {
          method: "delete",
          headers: {
            "Content-Type": "application/json",
  ...
  const getBookDataByID = async (id) => {
    ...
    // console.log(mainId);
    const response = await fetch(
      "http://localhost:8080/api/other/otherByID/" + id,
      {
        method: "get",
        headers: {
          "Content-Type": "application/json",
  ...
  const handleAdd = async (e) => {
    ...
    if (name.current.value === "") {
      ...
      const response = await fetch("http://localhost:8080/api/other/addother", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleUpdate = async (e) => {
    ...
    if (name.current.value === "") {
      ...
      const response = await fetch(
        "http://localhost:8080/api/other/updateother/" + bookId,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
