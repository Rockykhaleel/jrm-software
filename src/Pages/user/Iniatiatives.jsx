...
const Iniatiatives = ({ Toggle }) => {
  ...
  const deleteBook = async (id) => {
    const conf = confirm("Are you sure to remove this Other Iniatiatives?");
    if (conf) {
      const response = await fetch(BASE_URL + "other/deleteother/" + id, {
        method: "delete",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      if (response.status === 200) {
        Swal.fire({
          icon: "success",
          title: "Other Iniatiatives Deleted successfully!",
        });
  ...
  const downloadReport = async () => {
    try {
      const response = await fetch(
        BASE_URL + "other/getReportData/" + userId.id,
        {
          method: "GET",
          headers: {
            authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const getBookDataByID = async (id) => {
    ...
    // console.log(mainId);
    const response = await fetch(BASE_URL + "other/otherByID/" + id, {
      method: "get",
      headers: {
        "Content-Type": "application/json",
        authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleAdd = async (e) => {
    ...
    if (name.current.value === "") {
      ...
      const response = await fetch(BASE_URL + "other/addother", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      if (response.status === 201) {
        ...
        Swal.fire({
          icon: "success",
          title: "New Other Iniatiatives Added successfully!",
        });
      }
    }
  };
  ...
  const handleUpdate = async (e) => {
    ...
    if (name.current.value === "") {
      ...
      const response = await fetch(BASE_URL + "other/updateother/" + bookId, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      if (response.status === 200) {
        ...
        Swal.fire({
          icon: "success",
          title: "Other Iniatiatives Updated successfully!",
        });
      }
    }
  };
          ...
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title fs-5" id="exampleModalLabel">
                Add New / Update Other Iniatiatives
              </h1>
              <button
                type="button"
                className="btn-close"
