...
const Onlinepro = ({ Toggle }) => {
  ...
  const deleteBook = async (id) => {
    ...
    if (conf) {
      const response = await fetch(BASE_URL + "online/deleteonline/" + id, {
        method: "delete",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const downloadReport = async () => {
    try {
      const response = await fetch(
        BASE_URL + "online/getReportData/" + userId.id,
        {
          method: "GET",
          headers: {
            authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const getBookDataByID = async (id) => {
    ...
    // console.log(mainId);
    const response = await fetch(BASE_URL + "online/onlineByID/" + id, {
      method: "get",
      headers: {
        "Content-Type": "application/json",
        authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleAdd = async (e) => {
    ...
    if (progfor.current.value === "") {
      ...
      const response = await fetch(BASE_URL + "online/addonline", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleUpdate = async (e) => {
    ...
    if (progfor.current.value === "") {
      ...
      const response = await fetch(BASE_URL + "online/updateonline/" + bookId, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("token")}`,
