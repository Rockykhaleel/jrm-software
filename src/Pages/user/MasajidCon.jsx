...
const MasajidCon = ({ Toggle }) => {
  ...
  const fetchData = async (id) => {
    try {
      const response = await fetch(
        `http://localhost:8080/api/masjidcons/masjidconsByUserID/${id}`,
        {
          method: "GET",
          headers: {
  ...
  const deleteBook = async (id) => {
    ...
    if (conf) {
      const response = await fetch(
        "http://localhost:8080/api/masjidcons/deletemasjidcons/" + id,
        {
          method: "delete",
          headers: {
            "Content-Type": "application/json",
  ...
  const getBookDataByID = async (id) => {
    ...
    // console.log(mainId);
    const response = await fetch(
      "http://localhost:8080/api/masjidcons/masjidconsByID/" + id,
      {
        method: "get",
        headers: {
          "Content-Type": "application/json",
  ...
  const handleAdd = async (e) => {
    ...
    if (plan.current.value === "") {
      ...
      const response = await fetch(
        "http://localhost:8080/api/masjidcons/addmasjidcons",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleUpdate = async (e) => {
    ...
    if (plan.current.value === "") {
      ...
      const response = await fetch(
        "http://localhost:8080/api/masjidcons/updatemasjidcons/" + bookId,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
