...
const Schools = ({ Toggle }) => {
  // eslint-disable-next-line no-unused-vars
  const [isEditMode, setIsEditMode] = useState(false);
  const [isSuccess, setIsSuccess] = useState(false);
  const name = useRef();
  const noteachers = useRef();
  const nostudents = useRef();
  const classesdet = useRef();
  const facility = useRef();
  const feestruct = useRef();
  ...
  const deleteBook = async (id) => {
    const conf = confirm("Are you sure to remove this School/College?");
    if (conf) {
      const response = await fetch(BASE_URL + "school/deleteschool/" + id, {
        method: "delete",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      if (response.status === 200) {
        Swal.fire({
          icon: "success",
          title: "School/College Deleted successfully!",
        });
  ...
  const downloadReport = async () => {
    try {
      const response = await fetch(
        BASE_URL + "school/getReportData/" + userId.id,
        {
          method: "GET",
          headers: {
            authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const getBookDataByID = async (id) => {
    ...
    // console.log(mainId);
    const response = await fetch(BASE_URL + "school/schoolByID/" + id, {
      method: "get",
      headers: {
        "Content-Type": "application/json",
        authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleAdd = async (e) => {
    ...
    const obb = {
      ...
      noteachers: noteachers.current.value,
      nostudents: nostudents.current.value,
      classesdet: classesdet.current.value,
      facility: facility.current.value,
      feestruct: feestruct.current.value,
    ...
    if (name.current.value === "") {
    ...
    } else if (noteachers.current.value === "") {
      Swal.fire({
        icon: "warning",
        title: "Please enter Number of teachers",
      });
    } else if (nostudents.current.value === "") {
      Swal.fire({
        icon: "warning",
        title: "Please enter number of students",
      });
    } else if (classesdet.current.value === "") {
      Swal.fire({
        icon: "warning",
        title: "Please enter class details",
      });
    } else if (facility.current.value === "") {
      Swal.fire({
        icon: "warning",
        title: "Please enter facility provided",
      });
    } else if (feestruct.current.value === "") {
      Swal.fire({
        icon: "warning",
        title: "Please enter fee structure",
      });
    } else if (activities.current.value === "") {
      Swal.fire({
        icon: "warning",
        title: "Please enter activities conducted",
      });
      ...
      const response = await fetch(BASE_URL + "school/addschool", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      if (response.status === 201) {
        ...
        Swal.fire({
          icon: "success",
          title: "New School/College Added successfully!",
        });
      }
    }
  };
  ...
  const handleUpdate = async (e) => {
    ...
    if (name.current.value === "") {
      ...
      const response = await fetch(BASE_URL + "school/updateschool/" + bookId, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      if (response.status === 200) {
        ...
        Swal.fire({
          icon: "success",
          title: "Schools/Colleges Updated successfully!",
        });
      }
    }
  };
          ...
          <div className="ms-auto">
            <button
              ...
              onClick={() => {
                setIsEditMode(false);
                name.current.value = "";
                noteachers.current.value = "";
                nostudents.current.value = "";
                classesdet.current.value = "";
                facility.current.value = "";
                feestruct.current.value = "";
          ...
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title fs-5" id="exampleModalLabel">
                Add New / Update Schools/Colleges
              </h1>
              <button
                type="button"
                className="btn-close"
                  ...
                  <div className="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                    <div className="form-floating w-100">
                      <input
                        ...
                        className="form-control"
                        id="bookname"
                        defaultValue={bookObj.noteachers || "" || null}
                        placeholder="Book name"
                        ref={noteachers}
                        // onChange={(e) => setIsAddress(e.target.value)}
                      />
                      <label htmlFor="floatingInput">Number of teachers</label>
                    </div>
                  </div>
                </div>
                <div className="col-12">
                  <div className="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                    <div className="form-floating w-100">
                      <input
                        ...
                        className="form-control"
                        id="avail"
                        defaultValue={bookObj.nostudents || "" || null}
                        placeholder="avail"
                        ref={nostudents}
                  ...
                  <div className="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                    <div className="form-floating w-100">
                      <input
                        ...
                        className="form-control"
                        id="avail"
                        defaultValue={bookObj.classesdet || "" || null}
                        placeholder="avail"
                        ref={classesdet}
                        // onChange={(e) => setIsMember(e.target.value)}
                      />
                      <label htmlFor="floatingInput">Class details</label>
                    </div>
                  </div>
                </div>
                <div className="col-12">
                  <div className="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                    <div className="form-floating w-100">
                      <input
                        ...
                        className="form-control"
                        id="avail"
                        defaultValue={bookObj.facility || "" || null}
                        placeholder="avail"
                        ref={facility}
                        // onChange={(e) => setIsMember(e.target.value)}
                      />
                  ...
                  <div className="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                    <div className="form-floating w-100">
                      <input
                        ...
                        className="form-control"
                        id="avail"
                        defaultValue={bookObj.feestruct || "" || null}
                        placeholder="avail"
                        ref={feestruct}
                        // onChange={(e) => setIsMember(e.target.value)}
                      />
                      <label htmlFor="floatingInput">Fee structure</label>
                    </div>
                  </div>
                </div>
                <div className="col-12">
